package com.backend.vet.alejandralandaeta;
...
public class ReactivarUsuarioTest {
    ...
    public void verificarReactivacionUsuario() throws Exception {
        ...
        userField.clear();
        userField.sendKeys("adminServicios"); // Usuario ADMIN_USUARIOS creado en DataInitializer
        ...
        // Buscar la fila del usuario inactivo "userInactivoTest"
        WebElement filaUsuario = buscarFilaUsuario("userInactivoTest");
        Assert.assertNotNull(filaUsuario, "No se encontró la fila del usuario 'userInactivoTest'");
        ...
        WebElement btnReactivar = filaUsuario.findElement(
            By.xpath(".//button[@title='Reactivar usuario' or contains(@class, 'reactivate')]")
        );
        ...
        // Buscar y hacer click al botón "Reactivar" en el modal
        WebElement btnConfirmarReactivar = modalConfirm.findElement(
            By.xpath(".//button[contains(., 'Reactivar') or contains(@class, 'confirm')]")
        );
        ...
        filaUsuario = buscarFilaUsuario("userInactivoTest");
        ...
        System.out.println("✓ Test PASSED: Usuario 'userInactivoTest' reactivado exitosamente.");
    }
